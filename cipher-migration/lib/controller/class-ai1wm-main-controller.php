...
class Ai1wm_Main_Controller {
	...
	public function enqueue_import_scripts_and_styles( $hook ) {
		...
		wp_localize_script( 'ai1wm_import', 'ai1wm_uploader', array(
			...
			'filters'     => array(
				'ai1wm_archive_extension' => array( 'wpress', 'ncpress' ), // CIPHER_REBRAND
		...
		wp_localize_script( 'ai1wm_import', 'ai1wm_locale', array(
			...
			'invalid_archive_extension'           => __(
				...
				'Please ensure that your file is a <strong>.ncpress</strong> or <strong>.wpress</strong> file that was created with the All-in-One WP migration plugin. ' .
